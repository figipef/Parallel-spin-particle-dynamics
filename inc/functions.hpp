...
void createParticles(Particle*, int, std::string*, double*, Laser*, int); // Creates particles
void FieldDiagWritter(double&, int&, double*& fieldiag, Laser*& lasers, int& laser_number);
void setupInputVariable(std::ifstream&, int&, std::string*&, double*&, double&, double&, int&, std::string*&, double*&, double*&, double*&, int*&, int&, double*&, Laser*&, int&);
