...
double* f_RR(double, double[3], double[3], double[3]);
...
void setupInputVariable(std::ifstream&, int&, std::string*&, double*&, double*&, double*&, double&, double&, int&, std::string*&, double*&, double*&, double*&, int*&, int&, double*&, Laser*&, int&, int&, int*&);
